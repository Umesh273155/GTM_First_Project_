...
import poster_ from '../video/Rectangle 53 (7).png';
 ...
 function Video7(){
  return (
    <div className="videoContainer__">
      ...
      <h3 classname="headX" style={{marginLeft:"15px",marginTop:"17px"}}>Get Fit and Feel Great Best The Top-Rated Fitness Program </h3>
      ...
      <p>50 Students </p>
       ...
       <h2 style={{marginLeft:"19px",marginTop:"20px"}}>$150 <span><img src="dollor.png"alt="" style={{width:"30px",height:"20px"}}></img></span></h2> 
