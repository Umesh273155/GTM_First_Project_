...
import introVideo from  '../video/Yoga - 27089.mp4';
import './Video.css/Video1.css';
import poster_ from '../video/Rectangle 53 (2).png';
 ...
 function Video2(){
  return (
    <div className="videoContainer__">
      ...
      <h3 classname="headX" style={{marginLeft:"15px",marginTop:"17px"}}>Transform Your Body in 30 Days </h3>
      ...
      <p>50 Students </p>
       ...
       <h2 style={{marginLeft:"19px",marginTop:"20px"}}>$25 <span><img src="dollor.png"alt="" style={{width:"30px",height:"20px"}}></img></span></h2> 

       <button className="learn_More_btn" style={{marginTop:"20px"}}>Learn More  &#x2192; </button>
    </div>
  )
 }
