...
import poster_ from '../video/Rectangle 53 (6).png';
 ...
 function Video6(){
  return (
    <div className="videoContainer__">
      ...
      <h3 classname="headX" style={{marginLeft:"15px",marginTop:"17px"}}>Discover a Stronger , Healthier You with mediation program </h3>
      ...
      <p>50 Students </p>
       ...
       <h2 style={{marginLeft:"19px",marginTop:"20px"}}>$120 <span><img src="dollor.png"alt="" style={{width:"30px",height:"20px"}}></img></span></h2> 
