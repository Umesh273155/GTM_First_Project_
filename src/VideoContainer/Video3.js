...
import poster_ from '../video/Rectangle 53 (3).png';
 ...
 function Video3(){
  return (
    <div className="videoContainer__">
      ...
      <h3 classname="headX" style={{marginLeft:"15px",marginTop:"17px"}}>Transform Your Body with Our Best Selling Fitness Program </h3>
      ...
      <p>50 Students </p>
       ...
       <h2 style={{marginLeft:"19px",marginTop:"20px"}}>$40 <span><img src="dollor.png"alt="" style={{width:"30px",height:"20px"}}></img></span></h2> 
