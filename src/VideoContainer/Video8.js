...
import poster_ from '../video/Rectangle 53 (8).png';
 ...
 function Video8(){
  return (
    <div className="videoContainer__">
      ...
      <h3 classname="headX" style={{marginLeft:"15px",marginTop:"17px"}}>Join the Fitness Revolution with Fitness course </h3>
