...
import './Video.css/Video1.css';
 import poster_ from '../video/Rectangle 53 (1).png';
 ...
 function Video1(){
  return (
    <div className="videoContainer__">
      ...
      <h3 classname="headX" style={{marginLeft:"15px",marginTop:"17px"}}>Transform Your Body in 12 Weeks </h3>
      ...
      <p>50 Students</p>
       ...
       <h2 style={{marginLeft:"19px",marginTop:"20px"}}>$60 <span><img src="dollor.png"alt="" style={{width:"30px",height:"20px"}}></img></span></h2> 
